...
@av_cmd(pattern=r"^\.(yes|no|maybe|decide)$")
...
@av_cmd(pattern=r"^\.cry$")
async def cry(e):
    await e.edit(choice(CRI))


@av_cmd(pattern=r"^\.insult$")
async def insult(e):
...
@av_cmd(pattern=r"^\.hello$")
async def hoi(hello):
    await hello.edit(choice(HELLOSTR))


@av_cmd(pattern=r"^\.owo(?: |$)(.*)")
async def focos(owo):
...
@av_cmd(pattern=r"^\.react$")
async def react_meme(react):
    await react.edit(choice(FACEREACTS))


@av_cmd(pattern=r"^\.shg$")
async def shrugger(shg):
    await shg.edit(choice(SHGS))


@av_cmd(pattern=r"^\.chase$")
async def police(chase):
    await chase.edit(choice(CHASE_STR))


@av_cmd(pattern=r"^\.run$")
async def runner_lol(run):
    await run.edit(choice(RUNS_STR))


@av_cmd(pattern=r"^\.metoo$")
...
@av_cmd(pattern=r"^\.10iq$")
async def iqless(e):
    await e.edit("♿")


@av_cmd(pattern=r"^\.fuck$")
async def iqbot(e):
    await e.edit("🖕🖕🖕🖕🖕🖕🖕🖕\n🖕🖕🖕🖕🖕🖕🖕🖕\n🖕🖕\n🖕🖕\n🖕🖕\n🖕🖕🖕🖕🖕🖕\n🖕🖕🖕🖕🖕🖕\n🖕🖕\n🖕🖕\n🖕🖕\n🖕🖕\n🖕🖕")


@av_cmd(pattern=r"^\.bye$")
async def iqboot(e):
    await e.edit("Kek thx bye")


@av_cmd(pattern=r"^\.moon$")
...
@av_cmd(pattern=r"^\.taco$")
async def taco(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit(r"{\__/}" "\n(●_●)" "\n( >🌮 Want a taco?")


@av_cmd(pattern=r"^\.paw$")
async def paw(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("`(=ↀωↀ=)")
