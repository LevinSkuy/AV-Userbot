...
REPOLINK = str(
    UPSTREAM_REPO_URL) if UPSTREAM_REPO_URL else "https://github.com/Yansensad/AV-Userbot"
# ============================================
...
@av_cmd(pattern="shutdown$")
async def killdabot(event):
    """ For .shutdown command, shut the bot down."""
    await edit_or_reply(event, "`Mematikan AV-Userbot....`")
...
@av_cmd(pattern="restart$")
async def killdabot(event):
    await edit_or_reply(event, "`Restarting AV-Userbot...`")
...
@av_cmd(pattern="readme$")
async def reedme(e):
    await edit_or_reply(e,
                        "Here's Something for You to Read :\n"
                        "\n[✨ AV-Userbot Repo](https://github.com/Yansensad/AV-Userbot/blob/Av-Userbot/README.md)"
                        "\n[Setup Guide - Basic](https://telegra.ph/How-to-host-a-Telegram-Userbot-11-02)"
                        "\n[Special - Note](https://telegra.ph/Special-Note-11-02)")


@av_cmd(pattern="repeat (.*)")
...
async def repo_is_here(wannasee):
    ...
    await edit_or_reply(wannasee,
                        "**Hey**, I am using **✨ᴀᴠ-υѕєявσт✨** \n"
                        "卍━━━━━━━━━━━━━━━━━━━━━━卍\n"
                        "➣ **Repo Userbot :** [ɢɪᴛʜᴜʙ](https://github.com/Yansensad/AV-Userbot)\n"
