    ...
    if chat.id != OWNER_ID:
        ...
        if customstrmsg is not None:
            ...
            start_msg = f"**Users**: {mention}\
                        ...
                        \n**Forward**: True\
                        \n\n**Powered by**: [AV-Userbot](https://github.com/Yansensad/AV-Userbot)"
            buttons = [
                (
...
async def infor(event):
    await tgbot.send_message(
        event.chat_id,
        message=f"**Groups**: [sᴜᴘᴘᴏʀᴛ](t.me/pantekyks)\n**Github**: [AV-Userbot](https://github.com/Yansensad/AV-Userbot)\n**Deploy**: [Heroku](https://dashboard.heroku.com/new?template=https://github.com/Yansensad/AV-Userbot)",
        buttons=[
            [
                custom.Button.inline(
                    "ᴄʟᴏꜱᴇ",
