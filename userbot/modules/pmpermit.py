...
CUSTOM_TEXT = str(
    PMPERMIT_TEXT) if PMPERMIT_TEXT else f"__Halo kawan, saya bot yang menjaga room chat AV-Userbot {DEFAULTUSER} di mohon jangan melakukan spam , kalau anda melakukan itu OTOMATIS saya akan memblockir anda!__ \n"
DEF_UNAPPROVED_MSG = (
    "╔═════════════════════╗\n"
    ...
    "╔═════════════════════╗\n"
    f"➠ **Owner :** {ALIVE_NAME} \n"
    f"➠ **Pesan Otomatis by AV-Userbot** \n"
    "╚═════════════════════╝")
# =================================================================
...
@av_cmd(pattern="(set|get|reset) pm_msg(?: |$)(\\w*)")
